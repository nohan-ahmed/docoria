    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_image', models.ImageField(blank=True, null=True, upload_to=core.utils.user_directory_path)),
                ('cover_image', models.ImageField(blank=True, null=True, upload_to=core.utils.user_directory_path)),
                ('gender', models.CharField(choices=[('male', 'Male'), ('female', 'Female'), ('others', 'Othsers')], max_length=50)),
